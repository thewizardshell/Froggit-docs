...
export default defineConfig({
    site: 'https://froggit-docs.vercel.app',
    integrations: [starlight({
        ...
        head: [
            {
                tag: 'meta',
                attrs: { property: 'og:image', content: 'https://froggit-docs.vercel.app/og_image.png' },
            },
            {
                tag: 'meta',
                attrs: { name: 'twitter:image', content: 'https://froggit-docs.vercel.app/og_image.png' },
            },
        ],
        defaultLocale: 'root',
        locales: {
